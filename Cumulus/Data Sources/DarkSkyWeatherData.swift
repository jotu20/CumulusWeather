...
public func fetchDarkSkyWeatherData() {
    ...
    client.getForecast(location: userLocation) { result in
        ...
        case .success(let currentForecast, _):
            ...
            // MARK: - Seven day forecast values
            ...
            if let daily = currentForecast.daily {
                ...
                highTemperature = Int(fetchDayZeroArray.temperatureHigh!)
                lowTemperature = Int(fetchDayZeroArray.temperatureLow!)
                dewPoint = Int(fetchDayZeroArray.dewPoint!)
                ...
                dayZeroSummaryString = "\(fetchDayZeroArray.summary!)"
                ...
                dayZeroMoonPhaseString = moonPhase(percentage: fetchDayZeroArray.moonPhase! * 100)
                ...
                dayOneSummaryString = "\(fetchDayOneArray.summary!)"
                ...
                dayOneMoonPhaseString = moonPhase(percentage: fetchDayOneArray.moonPhase! * 100)
                ...
                dayTwoSummaryString = "\(fetchDayTwoArray.summary!)"
                ...
                dayTwoMoonPhaseString = moonPhase(percentage: fetchDayTwoArray.moonPhase! * 100)
                ...
                dayThreeSummaryString = "\(fetchDayThreeArray.summary!)"
                ...
                dayThreeMoonPhaseString = moonPhase(percentage: fetchDayThreeArray.moonPhase! * 100)
                ...
                dayFourHigh = Int(fetchDayFourArray.temperatureHigh!)
                dayFourLow = Int(fetchDayFourArray.temperatureLow!)
                dayFourSummaryString = "\(fetchDayFourArray.summary!)"
                ...
                dayFourMoonPhaseString = moonPhase(percentage: fetchDayFourArray.moonPhase! * 100)
                
                // Day Five
                let dayFiveArray = daily.data[5]
                ...
                dayFiveHigh = Int(fetchDayFiveArray.temperatureHigh!)
                dayFiveLow = Int(fetchDayFiveArray.temperatureLow!)
                dayFiveSummaryString = "\(fetchDayFiveArray.summary!)"
                ...
                dayFiveMoonPhaseString = moonPhase(percentage: fetchDayFiveArray.moonPhase! * 100)
                
                // Day Six
                let daySixArray = daily.data[6]
                ...
                daySixHigh = Int(fetchDaySixArray.temperatureHigh!)
                daySixLow = Int(fetchDaySixArray.temperatureLow!)
                daySixSummaryString = "\(fetchDaySixArray.summary!)"
                ...
                daySixMoonPhaseString = moonPhase(percentage: fetchDaySixArray.moonPhase! * 100)
                
                // Day Seven
                let daySevenArray = daily.data[7]
                ...
                daySevenHigh = Int(fetchDaySevenArray.temperatureHigh!)
                daySevenLow = Int(fetchDaySevenArray.temperatureLow!)
                daySevenSummaryString = "\(fetchDaySevenArray.summary!)"
                ...
                daySevenMoonPhaseString = moonPhase(percentage: fetchDaySevenArray.moonPhase! * 100)
            }
